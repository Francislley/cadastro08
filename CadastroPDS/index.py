...
class Ui_IndexDialog(object):
    def setupUi(self, IndexDialog):
        ...
        self.label_8.setGeometry(QtCore.QRect(430, 30, 61, 51))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(150, 70, 241, 230))
        ...
        self.lineEditNasc = QtGui.QLineEdit(self.layoutWidget)
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(50, 70, 81, 231))
